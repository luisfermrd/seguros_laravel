<x-app-layout>
    <x-container>
        <x-formulario>
            <x-slot name="titulo">
                Formulario de seguro de vehículo
            </x-slot>
            ...
            <x-slot name="formulario">
                <div class="form-group col-lg-12">
                    <x-contenedor_input>
                        <x-jet-label class="font-semibold" for="cumple_seguro"
                            value="{{ __('Cuando le cumple el seguro?(*)') }}" />
                ...
                <div class="row d-flex">
                    ...
                    <x-contenedor_input>
                        <x-jet-label class="font-semibold" for="tipo_vehiculo"
                            value="{{ __('Tipo de vehículo(*):') }}" />
                    ...
                    <x-contenedor_input>
                        ...
                        <x-jet-input id="otra_marca" name="otra_marca" type="text" :value="old('otra_marca')"
                    ...
                    <x-contenedor_input>
                        ...
                        <x-jet-input id="modelo" name="modelo" type="number" :value="old('modelo')"
                            class="form-control" required placeholder="" value="" />
                    ...
                    <x-contenedor_input>
                        ...
                        <x-jet-input id="version" name="version" type="text" :value="old('version')"
                            class="form-control" required placeholder="" value="" />
                    ...
                    <x-contenedor_input>
                        ...
                        <x-jet-input id="motor" name="motor" type="text" :value="old('motor')"
                            class="form-control" required placeholder="" value="" />
                    ...
                    <x-contenedor_input>
                        ...
                        <x-jet-input id="cv" name="cv" type="text" :value="old('cv')"
                            class="form-control" required placeholder="" value="" />
                    ...
                    <x-contenedor_input>
                        ...
                        <x-jet-input id="matricula" name="matricula" type="text" :value="old('matricula')"
                            class="form-control" required placeholder="" value="" />
                ...
                <div class="row d-flex">
                    <x-contenedor_input>
                        <x-jet-label class="font-semibold" for="nombres"
                            value="{{ __('Nombres y apellidos(*):') }}" />
                        <x-jet-input id="nombres" name="nombres" type="text" :value="old('nombres')"
                            class="form-control" required placeholder="" value="" />
                    ...
                    <x-contenedor_input>
                        ...
                        <x-jet-input id="email" name="email" type="email" :value="old('email')"
                            class="form-control" required placeholder="" value="" />
                    ...
                    <x-contenedor_input>
                        ...
                        <x-jet-input id="celular" name="celular" type="number" :value="old('celular')"
                            class="form-control" required placeholder="" value="" />
                        <x-jet-input-error for="celular" class="mt-2" />
                    </x-contenedor_input>

                    <x-contenedor_input>
                        <x-jet-label class="font-semibold" for="tipo_documento"
                            value="{{ __('Tipo de documento(*)') }}" />
                    ...
                    <x-contenedor_input>
                        <x-jet-label class="font-semibold" for="num_documento"
                            value="{{ __('Numero de documento(*):') }}" />
                        <x-jet-input id="num_documento" name="num_documento" type="number" :value="old('num_documento')"
                            class="form-control" required maxlength="10" required placeholder="" value="" />
                    ...
                    <x-contenedor_input>
                        <x-jet-label class="font-semibold" for="fecha_carnet"
                            value="{{ __('Fecha de carnet conducir:') }}" />
                        <x-jet-input id="fecha_carnet" name="fecha_carnet" type="date" :value="old('fecha_carnet')"
                            class="form-control" required maxlength="10" required placeholder="" value="" />
