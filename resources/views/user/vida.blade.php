        ...
        <x-formulario>
            ...
            <x-slot name="formulario">
                <x-contenedor_input>
                    ...
                    <x-jet-input id="nombres" name="nombres" type="text" :value="old('num_personas')" class="form-control" required
                        placeholder="Nombres y apellidos" value="" />
                ...
                <x-contenedor_input>
                    ...
                    <x-jet-input id="num_documento" name="num_documento" type="number" :value="old('num_documento')"
                        class="form-control" required placeholder="Numero de documento" value="" />
                    <x-jet-input-error for="num_documento" class="mt-2" />
                </x-contenedor_input>

                <x-contenedor_input>
                    <x-jet-label class="font-semibold" for="fecha_nacimiento"
                        value="{{ __('Fecha de nacimiento(*):') }}" />
                    <x-jet-input id="fecha_nacimiento" name="fecha_nacimiento" type="date" :value="old('fecha_nacimiento')"
                        class="form-control" required placeholder="Fecha de nacimiento" value="" />
                ...
                <x-contenedor_input>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <input type="radio" name="estado_civil" value="Soltero" required>
                            <label>Soltero</label><br>
                            <input type="radio" name="estado_civil" value="Separado"> <label>Separado</label>
                        </div>
                        <div class="col-6">
                            <input type="radio" name="estado_civil" value="Union libre"> <label>Union
                                libre</label><br>
                ...
                <x-contenedor_input>
                    ...
                    <x-jet-input id="celular" name="celular" type="number" :value="old('celular')" class="form-control"
                        required placeholder="Celular" value="" />
                ...
                <x-contenedor_input>
                    ...
                    <x-jet-input id="direccion" name="direccion" type="text" :value="old('direccion')" class="form-control"
                        minlength="5" required placeholder="Direccion de domicilio" value="" />
                ...
                <x-contenedor_input>
                    ...
                    <x-jet-input id="ciudad" name="ciudad" type="text" :value="old('ciudad')" minlength="5"
                        class="form-control" required placeholder="Ciudad/Municipio" value="" />
                    <x-jet-input-error for="ciudad" class="mt-2" />
                </x-contenedor_input>

                <x-contenedor_input>
                    <x-jet-label class="font-semibold" for="ingreso" value="{{ __('Ingreso mensual(*):') }}" />
                    <x-jet-input id="ingreso" name="ingreso" type="number" :value="old('ingreso')" class="form-control"
                        required placeholder="Ingreso mensual" value="" />
                    <x-jet-input-error for="ingreso" class="mt-2" />
                </x-contenedor_input>

                <x-contenedor_input>
                    <x-jet-label class="font-semibold" for="profesion" value="{{ __('Profesion:') }}" />
                    <x-jet-input id="profesion" name="profesion" type="text" :value="old('profesion')" class="form-control"
                        required placeholder="Profesion" value="" />
                    <x-jet-input-error for="profesion" class="mt-2" />
                </x-contenedor_input>

                <x-contenedor_input>
                    <x-jet-label class="font-semibold" for="medicamento"
                        value="{{ __('Consume actualmente algún medicamento?:') }}" />
                    <div>
                ...
                <x-contenedor_input>
                    <x-jet-label class="font-semibold" for="cual"
                        value="{{ __('En caso de consumir medicamento cual?') }}" />
                    <x-jet-input id="cual" name="cual" type="text" :value="old('profesion')" class="form-control"
                        required placeholder="Cual medicamento" value="" />
                    <x-jet-input-error for="cual" class="mt-2" />
                </x-contenedor_input>

                <x-contenedor_input>
                    <x-jet-label class="font-semibold" for="eps_ips"
                        value="{{ __('A que EPS e IPS está afiliado? (*):') }}" />
                    <x-jet-input id="eps_ips" name="eps_ips" type="text" :value="old('eps_ips')"
                        class="form-control" required placeholder="EPS e IPS" value="" />
                    <x-jet-input-error for="eps_ips" class="mt-2" />
                </x-contenedor_input>

                <x-contenedor_input>
                    <x-jet-label class="font-semibold" for="fecha_inicio"
                        value="{{ __('Fecha de inicio del seguro:') }}" />
                    <x-jet-input id="fecha_inicio" name="fecha_inicio" type="date" :value="old('fecha_inicio')"
                        class="form-control" required placeholder="" value="" />
                    <x-jet-input-error for="fecha_inicio" class="mt-2" />
                </x-contenedor_input>

                <x-contenedor_input>
                    <x-jet-label class="font-semibold" for="fecha_fin"
                        value="{{ __('Fecha de finalización del seguro:') }}" />
                    <x-jet-input id="fecha_fin" name="fecha_fin" type="date" :value="old('fecha_fin')"
                        class="form-control" required placeholder="" value="" />
